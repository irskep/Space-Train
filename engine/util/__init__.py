...
'ui/purseopen.png',
'actors/thermostat/icon.png',
'environments/spacebackground.png',
'actors/tourist/icon.png',
'actors/inga/sit.png',
'actors/luggage/icon.png',
...
'actors/hold_steady_fat_man/icon.png',
...
'actors/inga/icon.png',
'actors/monitor/icon.png',
...
'actors/hipster_liam/icon.png',
'actors/shamus/icon.png',
'actors/luggage/luggage2.png',
'actors/space_bucks/icon.png',
