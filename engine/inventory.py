...
class Inventory(object):
    ...
    def __init__(self):
        ...
        for sprite in self.sprites['closed']:
            x += sprite.width
        self.sprites['closed'].append( self.load_sprite(['ui', 'inventory_left.png'], gamestate.norm_w + x, gamestate.norm_h, self.batches['closed']) )
        x = 0
        for sprite in self.sprites['closed']:
            x += sprite.width
        self.sprites['closed'].append( self.load_sprite(['ui', 'inventory_mid.png'], gamestate.norm_w + x, gamestate.norm_h, self.batches['closed']) )
        x = 0
        for sprite in self.sprites['closed']:
            x += sprite.width
        self.sprites['closed'].append( self.load_sprite(['ui', 'inventory_right.png'], gamestate.norm_w + x, gamestate.norm_h, self.batches['closed']) )
        ...
        x = 0
        self.sprites['open']['left'] = self.load_sprite(['ui', 'inventory_left.png'], gamestate.norm_w, gamestate.norm_h, self.batches['open'])
        x += self.sprites['open']['left'].width
        midsprite = self.load_sprite(['ui', 'inventory_mid.png'], gamestate.norm_w, gamestate.norm_h, self.batches['open'])
        ...
        self.sprites['open']['mid'][-1].x += x
        x += self.sprites['open']['mid'][-1].width
        self.sprites['open']['right'] = self.load_sprite(['ui', 'inventory_right.png'], gamestate.norm_w + x, gamestate.norm_h, self.batches['open'])
    ...
    def load_sprite(self, path, x, y, batch):
