...
# -----------------------------------------------------------------------------
''' Widget base class for all glydget widgets.

The Widget class is the base class for all glydget widgets. It provides the
common set of methodfor the widgets including:
...
class Widget(object):
    ...
    def show(self, batch=None, group=None):
        ''' Show widget on screen using given batch & group.

        :Parameters:
            `batch` : pyglet.graphics.Batch_
    ...
    focused = property(_get_focused,
                       doc = '''Indicate whether widget is currently focused. ''')
    ...
    activated = property(_get_activated,
                         doc = ''' Indicate whether widget is currently activated. ''')
    ...
    style = property(_get_style, _set_style,
                 doc=''':class:`Style` associated to the widget. ''')
    ...
    parent = property(_get_parent,
                    doc = '''Parent container of the widget or None if
    ...
    root = property(_get_root,
                    doc = '''Toplevel container of the widget or self if
                             the widget has no parent.''')
    ...
    x = property(_get_x,
                 doc='''X coordinate of widget top-left corner. ''')
    ...
    y = property(_get_y,
                 doc='''Y coordinate of widget top-left corner. ''')
    ...
    batch = property(_get_batch,
                      doc='''Graphic batch_ where widget is currently in. ''')
    ...
    group = property(_get_group,
                      doc='''Graphic group_ this widget belongs. ''')
