...
#Button.foreground_colors[state.default]    = [195,199,206,100]*8
#Button.background_colors[state.default]    = [81,81,83,200]*2+[51,52,53,200]*2
#Button.foreground_colors[state.focused]    = [195,199,206,100]*8
#Button.background_colors[state.focused]    = [132,133,134,200]*2+[81,82,83,200]*2
#Button.foreground_colors[state.activated]  = [195,199,206,100]*8
#Button.background_colors[state.activated]  = [31,32,33,200]*2 + [81,81,83,200]*2
Button.halign = 0.5
...
#ArrowButton.background_colors[state.default]   = [220,220,220,50]*4
#ArrowButton.background_colors[state.focused]   = [220,220,220,75]*4
#ArrowButton.background_colors[state.activated] = [220,220,220,100]*4
